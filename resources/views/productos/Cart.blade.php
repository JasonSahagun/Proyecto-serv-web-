        ...
        <div class="container px-6 mx-auto">
            <div class="flex justify-center my-6">
                ...
                <div class="flex flex-col w-full p-8 text-gray-800 bg-white shadow-lg md:w-4/5 lg:w-4/5">
                    ...
                    <h3 class="text-3xl font-bold mb-4">Carrito</h3>
                    ...
                    <div class="flex-1">
                        ...
                        <table class="w-full text-sm lg:text-base">
                            ...
                            <tbody>
                                ...
                                @foreach ($cartItems as $item)
                                    @php
                                        // Si la imagen viene de S3 ya será una URL completa.
                                        // Si viene vacía, se pone un placeholder.
                                    ...
                                    <tr>
                                        ...
                                        <td class="justify-center mt-6 md:justify-end md:flex">
                                            <div class="h-10 w-28">
                                                <form action="{{ route('cart.update') }}" method="POST">
                                                    ...
                                                    <button class="px-4 mt-1 py-1.5 text-sm rounded shadow text-white bg-violet-600 hover:bg-violet-700">
                                                        Update
                                                    </button>
                                                </form>
                                            </div>
                                        ...
                                        <td class="hidden text-right md:table-cell">
                                            <form action="{{ route('cart.remove') }}" method="POST">
                                                @csrf
                                                <input type="hidden" value="{{ $item->id }}" name="id">
                                                <button class="px-4 py-2 text-white bg-red-600 shadow rounded-full hover:bg-red-700">
                                                    x
                                                </button>
                                            </form>
                                        </td>
                        ...
                        <div class="mt-4 flex gap-4">
                            ...
                            <form action="{{ route('cart.clear') }}" method="POST">
                                @csrf
                                <button class="px-6 py-2 text-sm rounded shadow text-white bg-red-500 hover:bg-red-600">
                                    Quitar todo
                                </button>
                            </form>
                            ...
                            <form action="{{ route('cart.order') }}" method="POST">
                                @csrf
                                <button class="px-6 py-2 text-sm rounded shadow text-white bg-blue-600 hover:bg-blue-700">
                                    Hacer pedido
                                </button>
                            </form>
