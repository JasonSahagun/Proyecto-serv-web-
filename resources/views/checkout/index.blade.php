...
<div class="container">
  <main>
    <div class="py-5 text-center">
      ...
      <h2>Registro </h2>
      <p class="lead">En este apartado tu puedes registrarte a nuestro servico hospitalario, simplemente 
    ...
    <div class="row g-5">
      ...
      <div class="col-md-0 ">
        ...
        <form class="needs-validation" novalidate>
          ...
          <button class="w-100 btn btn-primary btn-lg" type="submit">Continuar el registro</button>
        </form>
      </div>
    </div>
  </main>
